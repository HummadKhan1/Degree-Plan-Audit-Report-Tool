...
public class Course{
    ...
    public Course(Course other){
        ...
        this.attemptedCredits = other.attemptedCredits;
        this.earnedCredits = other.earnedCredits;
        this.letterGrade = other.letterGrade;
        this.points = other.points;
        this.semester = other.semester;
        this.transferType = other.transferType;
        this.levelingCourseDisposition = other.levelingCourseDisposition;
        this.degreePlanSection = other.degreePlanSection;
        this.repeatCourse = other.repeatCourse;
    }
